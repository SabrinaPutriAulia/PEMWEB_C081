      ...
      <div class="row">
        ...
        <input type="submit" class="btn btn-primary" name="submit" value="Hitung">
          ...
          if (isset($_POST['submit'])) {
            ...
            echo"<br><br><br> <br>";
            echo "<h6 style='margin: 30px 0 15px 0; '>Pendapatan kondektur dengan ID $id_kondektur pada bulan " . date("F", mktime(0, 0, 0, $bulan, 10)) . " sebesar: </h6>";
            echo "<div class ='form-control'><b>Rp " . number_format($total_gaji_kondektur, 0, ',', '.') . "</b></div>";
          }
