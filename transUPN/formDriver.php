        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="formDriver.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="nama driver" name="nama" required="required">
            </div>

            <div class="form-group">
              <label>No SIM Driver</label>
              <input type="text" class="form-control" placeholder="no sim driver" name="no_sim" required="required">
            </div>

            <div class="form-group">
              <label>Alamat Driver</label>
              <input type="text" class="form-control" placeholder="alamat driver" name="alamat" required="required">
            </div>
