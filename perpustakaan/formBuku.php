      ...
      if ($foto_nama != "") {
        ...
        if(in_array($ekstensi, $ekstensi_izin) === true)  {
          // Memindahkan File kedalam Folder "FOTO"
                ...
                $query = "INSERT INTO buku VALUES ('$kodeBuku', '$judul', '$penulis', '$penerbit', '$tahunTerbit', '$jumlahHalaman', '$kategori', '$foto_nama_new', '$stok')";
          ...
          // Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
                $query = "INSERT INTO buku (kodeBuku, judul, penulis, penerbit, tahunTerbit, jumlahHalaman, kategori, stok) VALUES ('$kodeBuku', '$judul', '$penulis', '$penerbit', '$tahunTerbit', '$jumlahHalaman', '$kategori', '$stok')";
